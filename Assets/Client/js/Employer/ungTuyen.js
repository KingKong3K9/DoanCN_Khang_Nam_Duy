    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response.data, function (index, value) {
                ...
                var timViecText = (value.TrangThaiTimViec == 0 || value.TrangThaiTimViec == null)
                    ? "Ứng viên tạm thời không muốn tìm việc nữa"
                    : "Đang tìm việc";
                str += "<td><span class='badge badge-warning'>" + timViecText + "</span></td>";
                var disabledClass = (value.TrangThaiTimViec == 0 || value.TrangThaiTimViec == null) ? "disabled" : "";
                ...
                str += `<br /><a href='/nha-tuyen-dung/UngTuyen/CapNhat?maUV=${value.MaUngVien}&maTTD=${value.MaTTD}' class='btn btn-warning mt-1 ${disabledClass}'>Cập nhật trạng thái</a></td>`;
                str += "</tr>";
